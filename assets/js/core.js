...
const TAGS = ['{이름}','{출발일}','{출발일요일}','{여행지}','{기간}','{여행사}','{출국편}','{미팅시간}','{미팅장소}','{귀국편}','{최저기온}','{최고기온}','{날씨}','{기온최저}','{기온최고}','{날씨안내}','{호텔명}','{호텔전화}','{가이드}','{가이드연락처}','{추가메모}','{기본수화물}'];
const STOPWORDS = new Set(['보호자','고객','손님','성인','소아','유아','룸조인','기사','인솔자','호텔','TEL','PHONE','연락처','항공','미팅','예약','대표','비상','안내','담당','팀장','팀원','선생','원장','부장','과장','차장','이사','대리','주임','실장','센터','여행','투어','번호','휴대폰','핸드폰','전화','문자','출발','도착','일정','가이드','한국','일본','국내','해외','현지']);
...
function createInitialState(){
  return {
    ...
    currentTravelInfo: {
      ...
      weatherMin:'', weatherMax:'', weatherNotice:'', baggageKg:''
    },
